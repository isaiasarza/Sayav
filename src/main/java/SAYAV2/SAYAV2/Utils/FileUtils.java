...
public class FileUtils {
	public static final String CONFIGURATOR_FILE = "configurator";
	public static final String USUARIO_FILE = "SAYAV";
	public static final String NOTIFICACIONES_FILE = "notificaciones";
	public static final String VOTACIONES_FILE = "votaciones";
	public static final String VOTACIONES_PENDIENTES_FILE = "votaciones_pendientes";
	public static final String MENSAJES_FILE = "mensajes";
	public static final String TIPOS_MENSAJES_FILE = "tipos_mensajes";
